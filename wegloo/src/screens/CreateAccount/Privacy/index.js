...
const Privacy = () => {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} style={{paddingTop:15, backgroundColor:color.white}}>
        <View style={responsiveStyle.headContainer}>
            ...
            <View style={responsiveStyle.privacyTextView}>
                <Text style={responsiveStyle.privacyText}>Privacy Policy</Text>
            </View>
        </View>

        <View style={responsiveStyle.content}>
            <Text style={responsiveStyle.frirstParagraph}>
            ...
            <Text style={responsiveStyle.secondParagraph}>
